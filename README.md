...
```
<p>👩‍💻 Software Engineering Student | 🇻🇳 Vietnam </br>💡 Passionate about problem-solving using strong data structures and algorithms skills. </br>🤝 Thrives in collaborative team environments; effective communication is a key strength.</br>💪 Excited about tackling complex problems and implementing effective solutions. </br>💻 Specializes in JavaScript (ReactJS, NextJS) and Python (Django, Flask) for full-stack proficiency.
...
<div style="display: flex; flex-wrap: wrap; justify-content: space-around;>
  ...
  <a href="https://nextjs.org/" target="_blank" rel="noreferrer"><img src="https://mikevpeeren.nl/_next/static/media/next_logo.79d7b4bd.png" alt="nextjs" width="50" height="50"/></a>
